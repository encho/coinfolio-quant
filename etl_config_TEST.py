...
MARKET_DATA_METADATA = [
    ...
    {"ticker": "USDT-USD", "base": "USDT", "quote": "USD",
        "yahoo_ticker": "USDT-USD", "name": "Tether/USD", "type": "CRYPTO", "version": 2},
    {"ticker": "BNB-USD", "base": "BNB", "quote": "USD",
        "yahoo_ticker": "BNB-USD", "name": "BNB/USD", "type": "CRYPTO", "version": 2},
    ...
    {"ticker": "GBP-USD", "base": "GBP", "quote": "USD",
        "yahoo_ticker": "GBPUSD=X", "name": "GBP/USD", "type": "FX", "version": 1},
    {"ticker": "EUR-USD", "base": "EUR", "quote": "USD",
        "yahoo_ticker": "EURUSD=X", "name": "EUR/USD", "type": "FX", "version": 1},
    {"ticker": "JPY-USD", "base": "JPY", "quote": "USD",
        "yahoo_ticker": "JPYUSD=X", "name": "JPY/USD", "type": "FX", "version": 1},
    ...
    {"ticker": "^N100", "base": "^N100", "quote": "EUR",
        "yahoo_ticker": "^N100", "name": "Euronext 100 Index", "type": "STOCK_INDEX", "version": 2},
    ...
    {"ticker": "NIKKEI_INDEX", "base": "NIKKEI225",
        "quote": "USD", "yahoo_ticker": "^N225", "name": "Nikkei Index", "type": "STOCK_INDEX", "version": 1},
    {"ticker": "AAPL", "base": "AAPL", "quote": "USD",
        "yahoo_ticker": "AAPL", "name": "Apple", "type": "STOCK", "version": 2},
    {"ticker": "AMZN", "base": "AMZN", "quote": "USD",
        "yahoo_ticker": "AMZN", "name": "Amazon", "type": "STOCK", "version": 2},
    {"ticker": "COIN", "base": "COIN", "quote": "USD",
        "yahoo_ticker": "COIN", "name": "Coinbase", "type": "STOCK", "version": 2},
    ...
    {"ticker": "TESLA", "base": "TESLA", "quote": "USD",
        "yahoo_ticker": "TSLA", "name": "Tesla", "type": "STOCK", "version": 1},
]
