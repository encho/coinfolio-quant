...
# import coinfolio_quant.datalake.cryptocurrencies as marketDataDB
# TODO rename
...
# TODO start_date and end_date should be determined by weights data in the database
# def load_backtest_into_database_FIRST_RUN(database, strategy_ticker, start_date, end_date):
